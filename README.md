...
# Self-Hosted App (Docker)

> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-docker)

- Deploy any Docker image as a [web service](https://docs.stacktape.com/compute-resources/web-services/) on AWS.
- Perfect for self-hosting tools like Uptime Kuma, Plausible, Metabase, n8n, or your own Docker containers.
- Includes optional [PostgreSQL database](https://docs.stacktape.com/resources/relational-databases/) — uncomment to
  enable.
...
```bash
stacktape init --starterId docker
```
...
```bash
stacktape dev --region <<your-region>> --stage <<stage>> --resourceName app
```
